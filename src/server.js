...
const { getMessages, searchRoom, addToRoom, postMessage, getRooms } = require("./controllers/chats");
...
class Server{
    ...
    routes() {
        ...
        this.app.post(ROUTES.REQUEST_ROOMS, authJwt.isUser, authJwt.verifyToken, getRooms);
    }
